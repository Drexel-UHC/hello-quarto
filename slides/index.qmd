...
[slides open sourced <br> mine çetinkaya-rundel + julia stewart lowndes <br> adopted by ran li]{.custom-author}
...
::: notes
Thank you so much Steve for organizing these meeting. Today I will be sharing about a thing call Quarto.
:::
...
::: notes
But also, we know you have questions. We did too. What is Quarto? Why is Quarto? And how does it relate to R Markdown and the workflows you already have? --\> Well
:::
...
--\> In our talk today, we'll introduce you to Quarto with some demos.
:::
...
::: notes
I will be presenting with four domains in mind. Sharing, collaborating, teaching and reimagine. Lets start with Sharing.
:::
